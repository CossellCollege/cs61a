...
def count_coins(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def constrained_coin(total,smallest_coin):
        if total == 0:
            return 1
        elif total < 0:
            return 0
        if smallest_coin == None:
            return 0
        without_coin = constrained_coin(total,next_larger_coin(smallest_coin))
        with_coin = constrained_coin(total-smallest_coin,smallest_coin)
